...
public class ConfigModelProviderFactory {
    ...
    public static IConfigModel getDefaultConfigModel(String configName) {
        return ExtensionLoader.getExtensionLoader(IConfigModelProvider.class).getExtension(configName).getDefaultConfigModel();
    }

    public static IConfigModel getConfigModel(String configName, String configGroup) {
        return ExtensionLoader.getExtensionLoader(IConfigModelProvider.class).getExtension(configName).getConfigModel(configGroup);
    }
}
